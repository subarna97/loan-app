                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        if (user != null) {
                                            if (user.isEmailVerified()) {
                                                ...
                                                Intent HomeActivity = new Intent(SignInActivity.this, Status_Main.class);
                                                ...
                                                errorView.setText("If your application is approved Please Verify your EmailID and SignIn ");
                                        ...
                                        Toast.makeText(SignInActivity.this, "your application is pending approval",
